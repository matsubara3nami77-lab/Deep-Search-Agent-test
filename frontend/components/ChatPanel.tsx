...
export default function ChatPanel({ messages, onSubmit, isLoading }: ChatPanelProps) {
      ...
      <div className="px-5 py-4 border-b border-gray-100 bg-white">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">Powered by Gemini 2.5 Flash Lite &amp; Tavily</p>
          </div>
        </div>
      </div>
